-- Importacao manual do fechamento de janeiro/2026
-- Ajuste apenas o email abaixo antes de executar no Supabase SQL Editor.
...
SET
  ...
  "isCreditCard" = EXCLUDED."isCreditCard",
  "installmentCurrent" = EXCLUDED."installmentCurrent",
  "installmentTotal" = EXCLUDED."installmentTotal",
...
SELECT
  ...
  NOW()
FROM target_user
ON CONFLICT ("userId", "monthReference") DO UPDATE
SET
  "cashBalance" = EXCLUDED."cashBalance",
  "digitalBalance" = EXCLUDED."digitalBalance",
  "note" = EXCLUDED."note",
  "updatedAt" = NOW();
