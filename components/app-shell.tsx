...
export function AppShell({
  ...
  return (
    <main className="min-h-screen bg-[#f5f2ec] px-2 py-2 dark:bg-[#111318] sm:px-3">
      <div className="min-h-screen mx-auto grid max-w-[1750px] gap-0 rounded-[20px] border border-slate-300 bg-[#efebe4] dark:border-slate-800 dark:bg-[#171a20] lg:grid-cols-[260px_240px_minmax(0,1fr)]">
        <AppShellSidebar
          user={user}
